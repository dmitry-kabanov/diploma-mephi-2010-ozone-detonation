...
private:
	...
	// Флаг, продолжать или начать расчет заново. Связан с переменной start, 
	// которая задает шаг времени, на котором начинается расчет.
	// Если resume равно нулю, то start должно быть равно 1.
	// Если resume равно единице, то, например, start, равное 5000, означает, что
